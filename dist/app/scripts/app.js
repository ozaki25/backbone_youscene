...
(function(root, factory) {
    ...
    Marionette.CollectionView = Marionette.View.extend({
        ...
        _renderChildren: function() {
            console.log(" CollectionView_renderChildren");
            this.destroyEmptyView();
            this.destroyChildren({checkEmpty: false});
    
            if (this.isEmpty(this.collection)) {
                console.log("this.isEmpty(this.collection)");
                this.showEmptyView();
            } else {
                console.log("!this.isEmpty(this.collection)");
    ...
    Marionette.CompositeView = Marionette.CollectionView.extend({
        ...
        resetChildViewContainer: function() {
            console.log("resetChildViewContainer");
            if (this.$childViewContainer) {
                console.log(this.$childViewContainer);
...
},{"./collections/Blogs":5,"./views/HeaderView":7,"./views/blogs/IndexView":9,"./views/blogs/NewView":10,"backbone":"backbone","backbone.marionette":2,"jquery":"jquery","underscore":"underscore"}],5:[function(require,module,exports){
var $ = require('jquery');
var _ = require('underscore');
var Backbone = require('backbone');
...
},{"backbone":"backbone","backbone.marionette":2,"jquery":"jquery","underscore":"underscore"}],8:[function(require,module,exports){
var $ = require('jquery');
var _ = require('underscore');
var Backbone = require('backbone');
var Marionette = require('backbone.marionette');
...
},{"./BlogView":8,"backbone":"backbone","backbone.marionette":2,"jquery":"jquery","underscore":"underscore"}],10:[function(require,module,exports){
var $ = require('jquery');
var _ = require('underscore');
var Backbone = require('backbone');
var Marionette = require('backbone.marionette');
...
},{"backbone":"backbone","backbone.marionette":2,"jquery":"jquery","underscore":"underscore"}],"backbone":[function(require,module,exports){
(function (global){
//     Backbone.js 1.3.2
